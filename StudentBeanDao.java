...
*/
public class StudentBeanDao extends AbstractDao<StudentBean, Integer> {
    ...
    @Override
    protected final Integer updateKeyAfterInsert(StudentBean entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public Integer getKey(StudentBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
